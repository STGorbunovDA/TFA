...
public class GetTopicsUseCaseShould
{
    ...
    private readonly ISetup<IGetTopicsStorage,Task<(IEnumerable<TopicDomain> resources, int totalCount)>> getTopicsSetup;
    ...
    public async Task ThrowForumNotFoundException_WhenNoForum()
    {
        ...
        getForumsSetup.ReturnsAsync(new ForumDomain[] { new() { Id = Guid.Parse("01B1C554-184B-4B32-913E-F7031AAD3BAC") } });
    ...
    public async Task ReturnTopics_ExtractedFromStorage_WhenForumExists()
    {
        ...
        getForumsSetup.ReturnsAsync(new ForumDomain[] { new() { Id = Guid.Parse("845D0972-0E11-4BD2-A102-299E99590267") } });
        var expectedResources = new TopicDomain[] { new() };
